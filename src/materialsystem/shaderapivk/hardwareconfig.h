...
{
    // VK_TODO: based on note below we could clean this up
...
//-----------------------------------------------------------------------------
class CHardwareConfig : public IMaterialSystemHardwareConfig /*IHardwareConfigInternal*/
{
  public:
    CHardwareConfig();
    ...
    void SetupHardwareCaps(const HardwareCaps_t &actualCaps);
    ...
    // DEFCONFIGMETHODs
    virtual bool SupportsStaticControlFlow() const { return 0; }
    virtual bool SupportsHDR() const { return 0; }
